...
class DonutsControllerTest < ActionController::TestCase
  ...
  test "should create donut" do
    assert_difference('Donut.count') do
      post :create, donut: { availableExtras: @donut.availableExtras, cost: @donut.cost, glazing: @donut.glazing, image: @donut.image, name: @donut.name, topping: @donut.topping }
    end
  ...
  test "should update donut" do
    patch :update, id: @donut, donut: { availableExtras: @donut.availableExtras, cost: @donut.cost, glazing: @donut.glazing, image: @donut.image, name: @donut.name, topping: @donut.topping }
    assert_redirected_to donut_path(assigns(:donut))
  end
